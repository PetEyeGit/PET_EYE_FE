...
function BookingCard({ booking, onCancel, cancelling, onReview }: {
        ...
        <div className="flex-1 p-5 flex flex-col gap-3 min-w-0">
          ...
          <div className="flex items-center gap-2 flex-wrap pt-1 border-t border-slate-50 dark:border-slate-700/50 mt-auto">
            ...
            {isCompleted && (
                ...
                className="inline-flex items-center gap-1.5 bg-amber-400 hover:bg-amber-500 text-[#122143] text-xs font-black px-4 py-2 rounded-xl shadow-md shadow-amber-500/20 transition-all"
                >
                <Star className="w-3.5 h-3.5 fill-current" /> Đánh giá ngay
                </button>
            )}
            <Link
              to="/messages"
