                ...
                {loading ? (
                    ...
                    <div className="space-y-4">
                        {filteredTasks.map((task) => (
                            <div key={task.bookingId} className="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 hover:shadow-xl transition-all duration-500 group">
                                <div className="flex flex-col md:flex-row gap-6">
                                    ...
                                    <div className="flex flex-row md:flex-col justify-center gap-2 shrink-0 md:border-l md:border-slate-100 md:pl-6">
                                        {task.status === 'CONFIRMED' && (
                                            <button 
                                                onClick={() => handleUpdateStatus(task.bookingId, 'IN_PROGRESS')}
                                        ...
                                        {task.status === 'IN_PROGRESS' && (
                                            <>
                                                ...
                                                <button 
                                                    onClick={() => handleUpdateStatus(task.bookingId, 'COMPLETED')}
                                                    disabled={updatingId === task.bookingId}
