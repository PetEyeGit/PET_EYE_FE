...
import { 
    ...
    X, Mail, Heart, Info, Scissors, Activity, Syringe, Utensils, Award, Send, Check, ShieldCheck, Sparkles, Calendar, BookOpen, Plus
} from 'lucide-react';
...
export default function StaffTasks() {
    ...
    const [activeRightTab, setActiveRightTab] = useState<'pet' | 'logs'>('pet');
                            ...
                            <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
                                <div className="flex flex-col lg:flex-row h-full">
                                    ...
                                    <div className="flex-1 p-6 sm:p-8 flex flex-col overflow-hidden">
                                        ...
                                        {/* Right Tab Switcher */}
                                        <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl mb-6 self-start">
                                            <button 
                                                            ...
                                                            <form onSubmit={handleAddCareLog} className="space-y-4">
                                                                ...
                                                                <div className="relative">
                                                                    <textarea 
                                                                        ...
                                                                        rows={3}
                                                                        className="w-full p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-xs outline-none focus:ring-2 focus:ring-indigo-500/10 transition-all resize-none font-medium text-slate-750 dark:text-slate-200"
                                                                    />
                                                                    <button 
                                                                        type="submit"
                                                                        disabled={submittingLog || !careLogNote.trim()}
                                                                        className="absolute bottom-3 right-3 p-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-lg transition-all disabled:opacity-50"
                                                                    >
