...
// ─── Quick actions ────────────────────────────────────────────────────────────
const QUICK_ACTIONS = [
  { icon: '📊', label: 'Phân tích doanh thu', color: 'bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100', prompt: 'Phân tích chi tiết doanh thu: tổng quan, xu hướng 7 ngày, dịch vụ đóng góp nhiều nhất. Đề xuất cải thiện cụ thể.' },
  { icon: '👑', label: 'Khách đặt nhiều nhất', color: 'bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100', prompt: 'Ai là khách hàng đặt lịch nhiều nhất? Liệt kê tên khách, số lần đặt, dịch vụ hay dùng. Đề xuất chương trình khách hàng thân thiết.' },
  { icon: '📅', label: 'Tổng quan lịch hẹn', color: 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100', prompt: 'Tổng hợp lịch hẹn theo trạng thái (chờ/xác nhận/hoàn thành/hủy). Có lịch tồn đọng không? Đề xuất tối ưu.' },
  { icon: '✂️', label: 'Dịch vụ hot & kém', color: 'bg-teal-50 text-teal-700 border-teal-200 hover:bg-teal-100', prompt: 'Dịch vụ nào được đặt nhiều nhất? Dịch vụ nào chưa ai đặt hoặc ít được chọn? Đề xuất chiến lược cải thiện.' },
  { icon: '👥', label: 'Thống kê nhân viên', color: 'bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100', prompt: 'Thống kê nhân viên: số lượng, trạng thái, chuyên môn, phân bổ công việc. Đề xuất tối ưu nhân sự.' },
  { icon: '⚠️', label: 'Cảnh báo & rủi ro', color: 'bg-red-50 text-red-700 border-red-200 hover:bg-red-100', prompt: 'Có vấn đề gì cần chú ý? Lịch tồn đọng, dịch vụ kém, nhân viên thiếu, doanh thu giảm? Đề xuất xử lý ngay.' },
  { icon: '🎯', label: 'Chiến lược tăng trưởng', color: 'bg-orange-50 text-orange-700 border-orange-200 hover:bg-orange-100', prompt: 'Dựa trên dữ liệu thực, đề xuất 3-5 chiến lược cụ thể để tăng doanh thu và khách hàng trong tháng tới.' },
  { icon: '📈', label: 'So sánh tháng này vs trước', color: 'bg-cyan-50 text-cyan-700 border-cyan-200 hover:bg-cyan-100', prompt: 'So sánh hiệu suất tháng này với tháng trước: doanh thu, lịch hẹn, khách hàng mới. Nhận xét xu hướng.' },
];
