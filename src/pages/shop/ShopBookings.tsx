                                ...
                                {listLoading ? (
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className="bg-white dark:bg-slate-800 rounded-[2rem] p-6 shadow-sm hover:shadow-xl transition-all border border-slate-100 dark:border-slate-700 group relative cursor-pointer"
                                        >
                                            <div className="flex flex-col lg:flex-row gap-6">
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div className="flex-1" onClick={(e) => e.stopPropagation()}>
                                                                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Phụ trách</p>
                                                                    <div className="relative">
                                                                        <select 
                                                                            ...
                                                                            className="w-full pl-0 pr-8 py-0 bg-transparent border-none text-xs font-bold text-indigo-600 focus:ring-0 cursor-pointer appearance-none"
                                                                        >
                                                                            <option value="">Chưa giao việc</option>
                                                                            {staffList.map(s => <option key={s.id} value={s.id}>{s.fullName}</option>)}
                                                                        </select>
                                                                        <ChevronDown size={12} className="absolute right-0 top-1/2 -translate-y-1/2 text-indigo-400 pointer-events-none" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="lg:w-48 flex flex-col justify-center gap-2" onClick={(e) => e.stopPropagation()}>
                                                ...
                                                <div onClick={(e) => e.stopPropagation()}>
                                                    ...
                                                    <div className="relative">
                                                        <select 
                                                            ...
                                                            className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2 py-1.5 text-[9px] font-bold text-slate-700 dark:text-slate-300 outline-none focus:ring-2 focus:ring-indigo-500/20 appearance-none cursor-pointer"
                                                        >
                                                            <option value="">Chưa giao việc</option>
                                                            {staffList.map(s => <option key={s.id} value={s.id}>{s.fullName}</option>)}
                                                        </select>
